...
public class CreateMaterial extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    Button createMaterial,uploadFile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MaterialId = getIntent().getExtras().getString("MaterialId");
    ...
    private void uploadMaterial(String title, String description, String secCode, String subjCode, String subj, String teacherUid) {
        if(!upfile) {
            ...
            reference.child(MaterialId).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
                public void onSuccess(Void unused) {
                    ...
                    reference1.child(secCode + subjCode).child("Materials").child(MaterialId).updateChildren(hashMap1);

                    DatabaseReference reference2 = FirebaseDatabase.getInstance().getReference("Subjects");
                    reference2.child(secCode + subjCode).child("Materials").child(MaterialId).updateChildren(hashMap1);
    ...
    private void showSettingsDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(CreateMaterial.this);
    ...
    private void handleSignInResult(Intent result) {
        GoogleSignIn.getSignedInAccountFromIntent(result)
                .addOnSuccessListener(googleAccount -> {
                    ...
                    mDriveServiceHelper = new DriveServiceHelper(googleDriveService,secCode,MaterialId, "Material");
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
